  ...
  const imageStyle = [
      ...
      const onSubmitHandler = async (e) => {
        ...
        try {
          ...
          const prompt = `Generate an image of
          ${input} in the style of ${selectedStyle}`;
        ...
        <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
          ...
          <div className="mt-3 flex gap-3 flex-wrap sm:max-w-9/11">
            ...
            imageStyle.map((item)=>(<span 
              ...
              onClick={()=>setSelectedStyle(item)} key={item}>{item}</span>))
            }
          </div>
        ...
        <div className="w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96">
          ...
          {!content ? (
            ...
            <div className="text-sm flex flex-col items-center gap-5 text-gray-400">
              ...
              <p className="Enter a topic and click 'Generate article' to get started">Enter a topic and click "Generate image" to get started</p>
            </div>
            </div>
            ) : (
